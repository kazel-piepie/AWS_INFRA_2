...
# Pulls LoL static/meta data from the Riot API; writes via the rorr DB secret.
# No MSK and no Bedrock. ai/rorr/develop is granted via the shared
# rorr_lol_task_secret attachment; only rorr/develop/riot is added here.
